            ...
            <div className="space-y-5">
                        ...
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="rounded-lg border border-slate-200 px-3 py-2 text-sm transition hover:bg-slate-50"
                                    title="Edit"
                                >
                                    ✏️
                                </button>
                        ...
                        <p className="mt-5 text-sm leading-6 text-slate-600">
                            ...
                            {announcement.message.length > 220 && (
                                ...
                                <button
                                    ...
                                    className="ml-2 font-bold text-[#10285d] hover:underline"
                                >
                                    Read more
                                </button>
                ...
                {filteredAnnouncements.length === 0 && (
                    ...
                    <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
                        ...
                        <h3 className="mt-3 text-lg font-bold text-[#12284a]">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full resize-none rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-[#10285d] focus:ring-2 focus:ring-[#10285d]/10"
                                    required
                                />
                            ...
                            <div className="flex justify-end gap-3 border-t border-slate-100 pt-5">
                                ...
                                <button
                                    type="submit"
                                    className="rounded-xl bg-[#10285d] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#173778]"
                                >
                                    📢 {editingId
                                        ? 'Update Announcement'
                                        : 'Post Announcement'}
                        ...
                        <div className="border-b border-slate-200 p-6">
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div>
                                    ...
                                    <h2 className="mt-4 text-2xl font-bold text-[#12284a]">
